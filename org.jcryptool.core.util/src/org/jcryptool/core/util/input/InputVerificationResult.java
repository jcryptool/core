 ...
 * {@link #isValid()}, because this is the most important thing to know about a
 * verification. Furthermore, there can be error messages or warnings, or no
 * comments at all (see {@link #getMessage()} and {@link #getMessageType()}).
 * 
 * @author Simon L
 */
public abstract class InputVerificationResult {
	...
	/**
	 * The message displayed for the verification (mostly only if it runs
	 * through with some error, warning or information)
	 */
	 ...
	 *         into a pattern of text in a 'usual way' or whether it has to be
	 *         displayed single and unchanged.
	 */
	public abstract boolean isStandaloneMessage();

	/**
	 * @return whether the validation was successful in general or not. In
	 *         Context of AbstractUIInput, changed made by user which create a
