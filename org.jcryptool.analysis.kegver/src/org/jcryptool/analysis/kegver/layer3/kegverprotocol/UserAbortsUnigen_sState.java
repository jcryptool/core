...
public class UserAbortsUnigen_sState extends KegverStateSuper implements KegverStateBehavior {

	public UserAbortsUnigen_sState(KegverStateContext inKegVer) {
		super(inKegVer);
	}
