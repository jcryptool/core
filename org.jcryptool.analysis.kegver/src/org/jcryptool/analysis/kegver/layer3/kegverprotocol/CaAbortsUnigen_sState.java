...
public class CaAbortsUnigen_sState extends KegverStateSuper implements KegverStateBehavior {

	public CaAbortsUnigen_sState(KegverStateContext inKegVer) {
		super(inKegVer);
	}
	...
	public void caAbortsUnigen_s() {
		...
		// Report
		U.verbose(new Throwable(), "CA aborts Unigen_s");
