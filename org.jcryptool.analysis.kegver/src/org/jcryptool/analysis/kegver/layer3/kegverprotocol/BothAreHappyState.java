...
public class BothAreHappyState extends KegverStateSuper implements KegverStateBehavior {

	public BothAreHappyState(KegverStateContext inKegVer) {
		super(inKegVer);
	}
	...
	public void bothAreHappy() {
		...
		// Report
		U.verbose(new Throwable(), "Congratulations, you made it");
