...
public class UserAborts_u extends UnigenStateSuper implements
		UnigenStateBehavior {

	public UserAborts_u(UnigenStateContext inUniGen) {
		super(inUniGen);
	}
	...
	public void userAborts_u() {
		U.verbose(new Throwable(), "User aborts! u fail");
	}
