...
//		wrapper.setContent(tfolder_1);
		...
		dESCon = new DESController();
		 ...
		 txtAlgInformation.setText(Messages.DesView_60 + Messages.DesView_70 +
		 Messages.DesView_80);
	}
...
//		comAlg.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
		comAlg.setLayout(new GridLayout(1, false));

		comAlgMain = new Composite(comAlg, SWT.NONE);
		comAlgMain.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
		...
		comAlgMainLeft.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false, false, 1, 1));
		comAlgMainLeft.setLayout(new GridLayout(1, false));

		comAlgMainRight = new Composite(comAlgMain, SWT.NONE);
		comAlgMainRight.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, true, false, 1, 1));
		comAlgMainRight.setLayout(new GridLayout(1, false));

		comAlgMainRightUp = new Composite(comAlgMainRight, SWT.NONE);
		comAlgMainRightUp.setLayoutData(new GridData(SWT.LEFT, SWT.FILL, true, false, 1, 1));
		comAlgMainRightUp.setLayout(new GridLayout(1, false));

		grpAlgInput = new Group(comAlgMainRightUp, SWT.NONE);
		grpAlgInput.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		...
		new Label(comAlgInputKey, SWT.NONE);
		new Label(comAlgInputKey, SWT.NONE);
		new Label(comAlgInputKey, SWT.NONE);
		new Label(comAlgInputKey, SWT.NONE);
		new Label(comAlgInputKey, SWT.NONE);
		...
		new Label(comAlgInputData, SWT.NONE);

		lblAlgInputPlaintext = new Label(comAlgInputData, SWT.NONE);
		lblAlgInputPlaintext.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false, 2, 1));
		...
		comAlgInputSepOut.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1));
		comAlgInputSepOut.setLayout(new GridLayout(2, false));

		lblAlgInputSeparator = new Label(comAlgInputSepOut, SWT.SEPARATOR | SWT.VERTICAL);
		lblAlgInputSeparator.setLayoutData(new GridData(SWT.LEFT, SWT.FILL, false, true, 1, 1));

		lblAlgInputCipherOut = new Label(comAlgInputSepOut, SWT.NONE);
		lblAlgInputCipherOut.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true, false, 1, 1));
		lblAlgInputCipherOut.setText(Messages.DesView_31);

		comAlgMainRightDown = new Composite(comAlgMainRight, SWT.NONE);
		comAlgMainRightDown.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1));
		comAlgMainRightDown.setLayout(new GridLayout(1, false));

		grpAlgOutput = new Group(comAlgMainRightDown, SWT.NONE);
		grpAlgOutput.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1));
		...
		tfAlgOutput.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1));
		...
		comAlgMainDown.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, true, false, 2, 1));
		...
		grpAlgStatus.setLayout(new GridLayout(1, false));
		...
		// Information Tab
		txtAlgInformation = new StyledText(grpAlgInformation, SWT.READ_ONLY | SWT.MULTI | SWT.WRAP | SWT.V_SCROLL);
		GridData layoutData = new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1);
		layoutData.widthHint = 350;
		txtAlgInformation.setLayoutData(layoutData);

		txtAlgInformation.setFont(FontService.getNormalFont());

		// Action Buttons
		btnAlgReset = new Button(comAlgMain, SWT.NONE);
		btnAlgReset.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false, 2, 1));
