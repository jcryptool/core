...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor {
    ...
    private IMenuManager createExtensionsMenu(String name, String type) {
        ...
        if(type.equals("analysis")) {
	        ...
	        Command cmd = service.getCommand("org.jcryptool.core.analysis.test");
	        cmd.define("Test", "This is my first attempt at creating a command programmatically", service.getCategory(CommandManager.AUTOGENERATED_CATEGORY_ID));
	        cmd.setHandler(new TestHandler());
	        
	        AbstractContributionFactory contribFactory = new AbstractContributionFactory ("menu:org.jcryptool.core.analysis", null) {
	        	@Override
	        	public void createContributionItems(IServiceLocator locator, IContributionRoot additions) {
	        		...
	        		additions.addContributionItem(createContributionItem(PlatformUI.getWorkbench(), null), null);
	        	}
	        };
    ...
    private IContributionItem createContributionItem(IServiceLocator locator, Object contribSource) {
    	CommandContributionItemParameter contributionItemParameter = new CommandContributionItemParameter(locator, null, "org.jcryptool.core.analysis.test", SWT.PUSH);
    ...
    public static IMenuManager createAlgorithmMenu() {
        ...
        for (CommandOrAction algorithmAction : algorithmActions) {
            ...
            if(algorithmAction.getAction() != null) {
            	sortedSubMenus.get(type).put(algorithmAction.getAction().getText(), algorithmAction.getAction());
            } 
            // TODO add a menu item if we have a Handler rather than an Action
            // else if(algorithmAction.getHandler() != null) {
            //	sortedSubMenus.get(type).put(algorithmAction.getCommandId(), null);
            // }
        }
