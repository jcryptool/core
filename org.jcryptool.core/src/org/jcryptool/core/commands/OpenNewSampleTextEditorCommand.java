...
public class OpenNewSampleTextEditorCommand extends AbstractHandler {

	@Override
	public Object execute(ExecutionEvent event) throws ExecutionException {
        IWorkbenchPage page = HandlerUtil.getActiveWorkbenchWindow(event).getActivePage();
        try {
            page.openEditor(AbstractEditorService.createTemporaryFile(), "org.jcryptool.editor.text.editor.JCTTextEditor");
