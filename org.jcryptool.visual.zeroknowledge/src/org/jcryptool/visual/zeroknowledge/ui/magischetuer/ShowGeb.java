...
/**
 * Klasse zum Zeichnen eines Gebäudes abhängig von der Wahl von Alice/Carol und
 * Bob.
 *
 * @author Mareike Paul
 * @version 1.0.0
...
public class ShowGeb implements PaintListener {
	...
	/**
	 * Konstruktor, der einen neuen Canvas erstellt und das erstellt Objekt als
	 * PaintListener hinzufügt.
	 *
	 * @param fall
	 *            Fall, der bestrachtet werden soll
	 * @param parent
	 *            Parent des Canvas
	 * @param b
	 *            M_Bob, der die Raumwahl enthält
	 */
	...
	public void paintControl(PaintEvent e) {
		...
		//Code to display the door code on the red line
	 ...
	 *
	 * @param visible
	 *            bestimmt die Sichtbarkeit des Canvas
	 */
