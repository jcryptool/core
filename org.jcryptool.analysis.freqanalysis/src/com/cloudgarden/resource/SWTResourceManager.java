...
public class SWTResourceManager {
	...
	/**
	 * This method should be called by *all* Widgets which use resources provided by
	 * this SWTResourceManager. When widgets are disposed, they are removed from the
	 * "users" Vector, and when no more registered Widgets are left, all resources
	 * are disposed.
	 * <P>
	 * If this method is not called for all Widgets then it should not be called at
	 * all, and the "dispose" method should be explicitly called after all resources
