...
public class FreqAnalysisCalc {
	 ...
	 * @param periodL returns only each periodL-th character (set it to 1 for the full text)
	...
	/**
	 * Analyse a text on his frequency distribution with a given character set (alphabet).
	 * @param inputText text to analyse
	 * @param length set to a value other than 1 if you want to analyse only a periodic subset of the text (see offset, too)
	 * @param offset set to a value other than 0 if you want to analyse only a periodic subset of the text (see offset, too)
	 * @param tModifySettings set zero, if you dont want to make restrictions on the character set of the text
	 */
	public FreqAnalysisCalc(final String inputText, final int length, final int offset, final TransformData tModifySettings, final String alphabet)
	{
	 ...
	 * @param tModifySettings set zero, if you dont want to make restrictions on the character set of the text
	 */
	public FreqAnalysisCalc(final String inputText, final int length, final int offset, final TransformData tModifySettings)
	{
		String myText = inputText;
	...
	{
		for(int i=0; i<data.length; i++) if(charToReprString(c).equals(data[i].charPrinted)) return i;
		return -1;
	}
	...
	private void doAnalysis(String alphabet)
	{
		...
		/**
		 * @author SLeischnig
		 * a comparator for sorting characters
		 */
