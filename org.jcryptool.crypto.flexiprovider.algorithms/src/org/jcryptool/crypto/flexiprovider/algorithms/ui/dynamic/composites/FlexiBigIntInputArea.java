...
public class FlexiBigIntInputArea implements IAlgorithmParameterInputArea {
	...
	public FlexiBigIntInputArea(Composite parent, String description) {
		GridData gridData = new GridData();
		gridData.horizontalAlignment = GridData.FILL;
		gridData.grabExcessHorizontalSpace = true;
		gridData.verticalAlignment = GridData.CENTER;
		Label descriptionLabel = new Label(parent, SWT.NONE);
		descriptionLabel.setText(NLS.bind(Messages.FlexiBigIntInputArea_0, description));
