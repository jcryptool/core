...
/**
 * <p>
 * This utility class contains a public list of different algorithms and corresponding key sizes available in the XML
 * Security Tools.
 * </p>
 * 
...
public interface IAlgorithms {
    ...
    String[] ENCRYPTION_KEY_ALGORITHMS = { "AES", "Blowfish", "DES", "DESede" };
    /** Encryption key algorithm sizes. */
    String[] ENCRYPTION_KEY_ALGORITHMS_SIZES = { "56", "64", "128", "192", "256", "320", "384", "448" };
    /** Canonicalization algorithms. */
    String[] CANONICALIZATION_ALGORITHMS = { "Exclusive without comments", "Exclusive with comments",
            "Inclusive without comments", "Inclusive with comments" };
    /** Canonicalization algorithms for the Basic Security Profile. */
    String[] CANONICALIZATION_ALGORITHMS_BSP = { "Exclusive without comments" };
    /** Transformation algorithms for the Basic Security Profile. */
    String[] TRANSFORMATION_ALGORITHMS_BSP = { "Exclusive without comments" };
    /** Transformation algorithms including none. */
    String[] TRANSFORMATION_ALGORITHMS = { "Exclusive without comments", "Exclusive with comments",
            "Inclusive without comments", "Inclusive with comments", "None" };
    /** Message Digest algorithms. */
    String[] MD_ALGORITHMS = { "MD5", "RIPEMD 160", "SHA 1", "SHA 256", "SHA 384", "SHA 512" };
    /** Message Digest algorithms for the Basic Security Profile. */
    String[] MD_ALGORITHMS_BSP = { "SHA 1" };
    /** Signature algorithms. */
    String[] SIGNATURE_ALGORITHMS = { "DSA with SHA 1 (DSS)", "Elliptic Curve DSA (ECDSA)", "RSA with MD5", "RSA",
            "RSA with RIPEMD160", "RSA with SHA 1", "RSA with SHA 256", "RSA with SHA 384", "RSA with SHA 512" };
    /** Signature algorithms for the Basic Security Profile. */
    String[] SIGNATURE_ALGORITHMS_BSP = { "RSA with SHA 1" };
    /** None algorithm. */
    String[] NONE_ALGORITHM = { "None" };
    /** Key wrap algorithms without the Basic Security Profile. */
    String[] KEY_WRAP_ALGORITHMS = { "AES-128 Key Wrap", "AES-192 Key Wrap", "AES-256 Key Wrap", "Triple DES Key Wrap" };
    /** Key wrap algorithms for the Basic Security Profile. */
    String[] KEY_WRAP_ALGORITHMS_BSP = { "AES-128 Key Wrap", "AES-256 Key Wrap", "Triple DES Key Wrap" };
    /** Encryption algorithms without the Basic Security Profile. */
    String[] ENCRYPTION_ALGORITHMS = { "AES 128", "AES 192", "AES 256", "Triple DES" };
