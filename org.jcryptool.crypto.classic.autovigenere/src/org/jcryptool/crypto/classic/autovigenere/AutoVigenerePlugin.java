 ...
 * @version 0.1
 */
public class AutoVigenerePlugin extends AbstractUIPlugin {
	/**
	 * The plug-in ID
	 */
	public static final String PLUGIN_ID = "org.jcryptool.crypto.classic.autovigenere";

	/**
	 * The shared instance
	 */
	private static AutoVigenerePlugin plugin;

	/**
	 * The constructor
	 */
	public AutoVigenerePlugin() {
		plugin = this;
	}
	 ...
	 */
	public static AutoVigenerePlugin getDefault() {
		return plugin;
	}
