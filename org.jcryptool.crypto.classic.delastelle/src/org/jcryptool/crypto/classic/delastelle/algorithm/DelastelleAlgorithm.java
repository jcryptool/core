 ...
 * @version 0.1
 */
public class DelastelleAlgorithm extends AbstractClassicAlgorithm {

    public static final DelastelleAlgorithmSpecification specification = new DelastelleAlgorithmSpecification();

    /**
     * Constructor The specific engine of the algorithm is assigned.
     *
     */
    public DelastelleAlgorithm() {
        engine = new DelastelleEngine();
