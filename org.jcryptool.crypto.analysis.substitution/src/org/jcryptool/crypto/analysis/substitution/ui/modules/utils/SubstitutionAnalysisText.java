...
public class SubstitutionAnalysisText extends Composite {
	...
	private String generatePlaintext(String ciphertext, HashMap<Character, Character> substitutions2, List<Integer> substitutionPositionsToFill, StringBuilder uppercaseFormBuilder) {
...
//
//		String myText = "ThisistheJCrypToolsamplefile.YoucanusethisfileforafaststartwithJCrypTool,e.g.byencryptingordigitallysigningitusingthe'Algorithms'menu,orbyapplyingoneoftheanalysisofferedinthe'Analysis'menu.Allcryptographicoperationsareadditionallyarrangedinthe'CryptoExplorer'viewontherightside.Adoubleclickontheselectedentryonthe'Algorithms'tablaunchesawizardwhichguidesyoustepbystepthroughtheencryptionprocess.Decryptingthefileatalatertimeworksthesameway.AllofferedalgorithmsaswellasallanalysisalwaysrequireanopenedfileinoneoftheJCrypTooleditors.Visualizationsandgamesontheotherhandarenormallyindependentofanyopenedfile.Youcaneitherusethissamplefileoropenanyofyourownfileswhereveroneisrequired.Theoriginalfileremainsuntouchedallthetime,everycryptographicoperationcreatesitsownworkingfile.Thefilterfieldontopofthe'CryptoExplo";
//		SubstitutionAnalysisText text = new SubstitutionAnalysisText(shell, SWT.NONE, myText, true);
//		text.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));
//
//		HashMap<Character, Character> substs = new HashMap<Character, Character>();
//		substs.put('T', 'X');
//		substs.put('A', 'R');
//		substs.put('E', 'L');
//		substs.put('D', 'F');
//		
//		text.setMapping(substs);
//		
//		shell.pack();
//		shell.open();
//		
//		shell.setSize(900, 250);
