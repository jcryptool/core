...
public class PreferencesManager {
	...
	static final TreeSet scalableSizes = new TreeSet(Arrays.asList(new Integer[] {new Integer(6),
            new Integer(7), new Integer(8), new Integer(9), new Integer(10), new Integer(11),
            new Integer(12), new Integer(13), new Integer(14), new Integer(16), new Integer(18),
    ...
    void createComposite() {
        ...
        sampleText = new Text(group, SWT.MULTI | SWT.WRAP | SWT.V_SCROLL | SWT.READ_ONLY
                | SWT.BORDER);
    ...
    /**
     * Creates the part containing all preferences-editing widgets, that is, ok and cancel buttons
     * are left out so we can call this method from both standalone and plugin.
     *
    ...
    public FontData getFontData() {
        return new FontData(sampleFontData.getName(), sampleFontData.getHeight(), sampleFontData
                .getStyle());
    }
	...
	void populateFixedCharWidthFonts() {
        fontsNonScalable = new ArrayList(Arrays.asList(Display.getCurrent()
	...
	void updateSizeItems() {
        ...
        for (Iterator j = sizes.iterator(); i < items.length; ++i)
            items[i] = ((Integer) j.next()).toString();
