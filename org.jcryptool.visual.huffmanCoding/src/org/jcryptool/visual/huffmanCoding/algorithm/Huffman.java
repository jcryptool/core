...
public class Huffman {
     ...
     *
     * This table is represented by an array of BitStrings, where table[i] holds the BitString for
     * the i-th character.
     *
     * You may use an array with 256 entries even if not every character occurs in the inputfile.
     */
    ...
    /**
     * This method performs the compression of the file inFilename. It writes the results to the
     * OutputStream out.
     *
    ...
    public void uncompress(String path) throws IOException {
        try (HuffmanStreamReader hsr = new HuffmanStreamReader(new FileInputStream(path))) {
            ...
            /*
             * Traverse the huffman tree. Read the input bit by bit. If bit == 1 go left, if bit ==
             * 0 go right
             */
    ...
    /**
     * This method returns the code table used by the last compress/uncompress operation.
     *
    ...
    private Node buildTreeReverse(BitString[] table) {
        ...
        /*
         * for all entry in the codeTable. get the i-th bitString from the codeTable and create
         * nodes for all bits from the bitString
         */
