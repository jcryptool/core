...
public class Identity extends TabItem {
	...
	private final String EXPLAIN_KEYMGMT_TAB1 = "3.Aktion: Schl\u00fcsselverwaltung - Neuen Schl\u00fcssel erstellen\n\nHier kann ein Schl\u00fcssel mit ausgew\u00e4hlten Parametern erstellt werden. Der RSA-Algorithmus ist in zwei Varianten implementiert:\n\n1) F\u00fcr den klassischen RSA-Algorithmus werden zwei verschiedene Primzahlen (p und q) ben\u00f6tigt. Diese k\u00f6nnen entweder aus der Liste ausgew\u00e4hlt oder eingegeben werden. Sofern die Parameter p und q zul\u00e4ssig sind, kann ein Exponent e angegeben werden, der entweder aus der Liste ausgesucht, durch den entsprechenden Button zuf\u00e4llig gew\u00e4hlt, oder eingegeben werden kann.\n\n2) Beim „multi-primen RSA“ muss zuerst die Anzahl der verwendeten Primzahlen (zwischen 3 und 5) festgelegt werden. Die Primzahlen und der Exponent k\u00f6nnen auch hier entweder aus der Liste gew\u00e4hlt, vom Programm generiert oder selbst eingegeben werden.\n\nAm Ende der Schl\u00fcsselerzeugung muss bei beiden Varianten des RSA-Algorithmus ein Passwort f\u00fcr den geheimen Schl\u00fcssel festgelegt werden.\n\nKlicken Sie auf den Button „Schl\u00fcssel erstellen“, um einen neuen Schl\u00fcssel mit den ausgew\u00e4hlten Parametern und dem ausgew\u00e4hlten Algorithmus im Schl\u00fcsselspeicher abzulegen.";
						...
						public void widgetSelected(SelectionEvent e) {
							if (radio_RSA.getSelection()){
								...
								if (bi_rsaD.toString().length() < 40){
									...
									errorLabel_1.setText("RSA-Schlüssel wurde erstellt. Schlüsseldetails aufgrund der Größe bitte im Reiter 'Meine Schlüssel' betrachten");
								}
					...
					createKey_Tab2.addSelectionListener(new SelectionListener() {
						...
						public void widgetSelected(SelectionEvent e) {
							if (radio_ExtRSA_tab2.getSelection()){
								...
								lbl_notification_tab2.setText("Klassischer RSA-Key erfolgreich erstellt. Schlüsseldetails aufgrund der Größe bitte im Reiter 'Meine Schlüssel' betrachten.");
...
//			if (!s.equals(this.identityName) && !recipients.contains(s)){
	...
	private void createActionGroup1(){
		...
		initActions.setText("Bitte w\u00e4hlen Sie ein Aktion f\u00fcr die Identit\u00e4t im aktuellen Tab ("+identityName+"), oder einen Button im Feld „Identit\u00e4ten-Verwaltung“.");
