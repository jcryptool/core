...
public class ModelComposite extends Composite {
    ...
    private void createActions() {
        ...
        /*
         * btnReturn.addSelectionListener(new SelectionAdapter() { public void
         * widgetSelected(SelectionEvent e) { try { Input.privateKey = null; Input.publicKey = null;
         * IWorkbenchPage page =
         * PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage(); IViewReference ref
         * = page.findViewReference("org.jcryptool.visual.sigVerification.view"); //$NON-NLS-1$
         * PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().hideView(ref);
         * page.closePerspective(null, false, true); } catch (Exception ex) {
