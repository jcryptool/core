 ...
 */
public class RSAChooseKeytypePage extends WizardPage {
    /** name of this page. */
     ...
     */
    public RSAChooseKeytypePage() {
        super(getPagename(), Messages.RSAChooseKeytypePage_choose_keytype, null);
        setDescription(Messages.RSAChooseKeytypePage_choose_type_text);
    }
    ...
    public final void createControl(Composite parent) {
        ...
        keypairButton.setText(Messages.RSAChooseKeytypePage_new_keypair);
        keypairButton.setToolTipText(Messages.RSAChooseKeytypePage_new_keypair_popup);
        ...
        pubkeyButton.setText(Messages.RSAChooseKeytypePage_new_pubkey);
        pubkeyButton.setToolTipText(Messages.RSAChooseKeytypePage_new_pubkey_popup);
    ...
    public final IWizardPage getNextPage() {
        if (keypairButton.getSelection()) {
            ...
            return getWizard().getPage(RSANewPublicKeyPage.getPagename());
        }
    }
