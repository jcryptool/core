 ...
 */
public class RSANewKeypairPage extends WizardPage {
    ...
    private static final String TITLE = Messages.RSANewKeypairPage_choose_params;
    ...
    private boolean checkParams() {
        ...
        if (!p.equals(Constants.MINUS_ONE) && !Lib.isPrime(p)) {
            setErrorMessage(Messages.RSANewKeypairPage_error_p_not_prime);
        }
        ...
        if (!n.equals(Constants.MINUS_ONE) && n.compareTo(Constants.TWOFIVESIX) < 0) {
            ...
            setErrorMessage(error + Messages.RSANewKeypairPage_error_n_lt_256);
        }
    ...
    public final void createControl(Composite parent) {
        ...
        elistUpdate.setText(Messages.RSANewKeypairPage_whole_list);
        elistUpdate.setToolTipText(Messages.RSANewKeypairPage_whole_list_popup);
        ...
        selectdtext.setText(Messages.RSANewKeypairPage_e_text);
        ...
        saveKeypairButton.setText(Messages.RSANewKeypairPage_save_keypair);
        saveKeypairButton.setToolTipText(Messages.RSANewKeypairPage_save_keypair_popup);
