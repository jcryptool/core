 ...
 * for Gentry & Halevi fully homomorphic visualization
 * @author Coen Ramaekers
 *
 */
public class GHChooseKeySelGenPage extends WizardPage {
	private static final String PAGENAME = "GH Keyselection or -generation"; //$NON-NLS-1$
	...
	public final IWizardPage getNextPage() {
		if (newKeyButton.getSelection()) {
			return this.getWizard().getPage(GHNewKeyPage.getPagename());
		} else {
