...
/**
 * Page to enter an operation number for RSA homomorphic visualization
 * @author Coen Ramaekers
 *
 */
public class RSAChooseOperationTextPage extends WizardPage{
    
    /** unique pagename to get this page from inside a wizard. */
    private static final String PAGENAME = "Choose RSA operation text Page";
    
    /** title of this page, displayed in the head of the wizard. */
    private static final String TITLE = Messages.GHChooseOperationTextPage_Title + " (RSA)";
    ...
    public RSAChooseOperationTextPage(RSAData data) {
    ...
    public final void createControl(final Composite parent) {
        ...
        Label lblSecondOperand = new Label(composite, SWT.NONE);
        GridData gd_lblSecondOperand = new GridData(SWT.FILL, SWT.FILL, true, false, 2, 1);
        lblSecondOperand.setLayoutData(gd_lblSecondOperand);
        lblSecondOperand.setText(Messages.GHChooseOperationTextPage_Textfield + " N" + Messages.GHChooseOperationTextPage_Textfield2);
        ...
        text.addModifyListener(new ModifyListener() {
            public void modifyText(final ModifyEvent e) {
                ...
                data.setOperation(((Text) e.widget).getText());
                usedText.setText((new BigInteger(data.getOperation())).mod(data.getN()).toString());
            }
        });
