...
public class PaillierChooseOperationTextPage extends WizardPage{
    ...
    private static final String TITLE = Messages.GHChooseOperationTextPage_Title + " (Paillier)";
    ...
    public final void createControl(final Composite parent) {
        ...
        lblN.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false));
        lblN.setText("N:");
        ...
        text.addModifyListener(new ModifyListener() {
            public void modifyText(final ModifyEvent e) {
                ...
                usedText.setText(data.getOperation().mod(data.getPubKey()[0]).toString());
            }
        });
