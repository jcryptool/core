 ...
 * @version 0.1
 */
public class PlayfairAlgorithm extends AbstractClassicAlgorithm {

    public static final PlayfairAlgorithmSpecification specification = new PlayfairAlgorithmSpecification();
