...
*******************************************************************************/
//-----END DISCLAIMER-----
package org.jcryptool.crypto.classic.vigenere;
 ...
 * @version 0.1
 */
public class VigenerePlugin extends AbstractUIPlugin {
	/**
	 * The plug-in ID
	 */
	 ...
	 * The shared instance
	 */
	private static VigenerePlugin plugin;
	
	/**
	 * The constructor
	 */
	public VigenerePlugin() {
		plugin = this;
	}
	 ...
	 */
	public static VigenerePlugin getDefault() {
		return plugin;
	}
