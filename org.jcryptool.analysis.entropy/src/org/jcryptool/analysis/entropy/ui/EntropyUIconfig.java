...
//					FormData buttonFilterLData = new FormData();
//					buttonFilterLData.width = 219;
//					buttonFilterLData.height = 23;
//					buttonFilterLData.left =  new FormAttachment(0, 1000, 5);
//					buttonFilterLData.top =  new FormAttachment(0, 1000, 5);
...
//					FormData buttonStandardAnalysisLData = new FormData();
//					buttonStandardAnalysisLData.width = 330;
//					buttonStandardAnalysisLData.height = 16;
//					buttonStandardAnalysisLData.left = new FormAttachment(0, 1000, 5);
//					buttonStandardAnalysisLData.top = new FormAttachment(0, 1000, 33);
//					buttonStandardAnalysisLData.right = new FormAttachment(1000, 1000, -9);
//					buttonStandardAnalysis.setLayoutData(buttonStandardAnalysisLData);
...
//					FormData cComboTupelLengthLData = new FormData();
//					cComboTupelLengthLData.width = 76;
//					cComboTupelLengthLData.left = new FormAttachment(0, 1000, 33);
//					cComboTupelLengthLData.top = new FormAttachment(0, 1000, 55);
//					cComboTupelLength.setLayoutData(cComboTupelLengthLData);
					for (int i = 1; i <= 30; i++) {
...
//					FormData buttonDeepAnalysisLData = new FormData();
//					buttonDeepAnalysisLData.width = 330;
//					buttonDeepAnalysisLData.height = 16;
//					buttonDeepAnalysisLData.left = new FormAttachment(0, 1000, 5);
//					buttonDeepAnalysisLData.right = new FormAttachment(1000, 1000, -9);
//					buttonDeepAnalysisLData.top = new FormAttachment(0, 1000, 85);
//					buttonDeepAnalysis.setLayoutData(buttonDeepAnalysisLData);
...
//					cLabel3LData.width = 326;
//					cLabel3LData.height = 19;
//					cLabel3LData.left = new FormAttachment(0, 1000, 9);
//					cLabel3LData.top = new FormAttachment(0, 1000, 113);
//					cLabel3LData.right = new FormAttachment(1000, 1000, -9);
...
//					FormData cComboSignificanceLData = new FormData();
//					cComboSignificanceLData.width = 76;
//					cComboSignificanceLData.left = new FormAttachment(0, 1000, 17);
//					cComboSignificanceLData.top = new FormAttachment(0, 1000, 138);
//					cComboSignificance.setLayoutData(cComboSignificanceLData);
			...
			}
			{
				...
				buttonStart.addSelectionListener(new SelectionAdapter() {
					public void widgetSelected(SelectionEvent evt) {
						...
						int n = cComboTupelLength.getSelectionIndex() + 1;
						double sig = getSignificance();
						if (buttonDeepAnalysis.getSelection()) {
							n = 50;
						}
						if (checkEditor()) {
							...
							if (input.length() >= n) {
								Thread entCalc = new Thread(new EntropyCalc(getEditorText(), n, sig, myModifySettings,
										entropyUIpointer, editorname));
								entropyUIpointer.getDisplay().asyncExec(entCalc);
								//entCalc.start();
							} else {
	...
	public EntropyUIconfig getThis() {
		return this;
	}
