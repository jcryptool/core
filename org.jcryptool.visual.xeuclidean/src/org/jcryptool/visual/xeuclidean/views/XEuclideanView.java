...
public class XEuclideanView extends ViewPart {
	private final String exportToLatexCommandId = "org.jcryptool.visual.xeuclidean.commands.exportToLatex";
	private final String exportToCSVCommandId = "org.jcryptool.visual.xeuclidean.commands.exportToCsv";
	private final String exportToPdfCommandId = "org.jcryptool.visual.xeuclidean.commands.exportToPdf";
    ...
    public void dispose() {
    	...
    	if(commandService != null) {
    		Command command = commandService.getCommand(exportToCSVCommandId);
    		command.undefine();
    		command = commandService.getCommand(exportToLatexCommandId);
    		command.undefine();
    		command = commandService.getCommand(exportToPdfCommandId);
    		command.undefine();
    	}
    ...
    public void createPartControl(Composite parent) {
        ...
        resetTableButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseUp(final MouseEvent e) {
                ...
                commandService.getCommand(exportToPdfCommandId).setHandler(null);
                commandService.getCommand(exportToLatexCommandId).setHandler(null);
                commandService.getCommand(exportToCSVCommandId).setHandler(null);
        ...
        computeButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseUp(final MouseEvent e) {
                ...
                if (pValue.compareTo("") != 0 && qValue.compareTo("") != 0) { //$NON-NLS-1$ //$NON-NLS-2$
                    ...
                    commandService.getCommand(exportToPdfCommandId).setHandler(exportToPdfHandler);
                    commandService.getCommand(exportToLatexCommandId).setHandler(exportToLatexHandler);
                    commandService.getCommand(exportToCSVCommandId).setHandler(exportToCSVHandler);
    ...
    private void defineAllCommands() {
        ...
        defineCommand(exportToPdfCommandId, Messages.XEuclideanView_ExportPDF_Menu, null);	// command initially disabled
        ...
        defineCommand(exportToCSVCommandId, Messages.XEuclideanView_ExportCSV_Menu, null);
        ...
        defineCommand(exportToLatexCommandId, Messages.XEuclideanView_ExportLatex_Menu, null);
