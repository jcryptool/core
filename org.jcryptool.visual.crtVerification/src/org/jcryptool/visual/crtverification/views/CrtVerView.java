...
public class CrtVerView extends ViewPart {
    ...
    public void createPartControl(Composite parent) {
        ...
        PlatformUI.getWorkbench().getHelpSystem()
                .setHelp(viewer.getControl(), "org.jcryptool.visual.crtVerification.viewer");
        makeActions();
        hookContextMenu();
    ...
    private void showMessage(String message) {
        MessageDialog.openInformation(viewer.getControl().getShell(), "Cert Verification", message);
    }
