...
public class JCTCA_Visual extends ViewPart {
    ...
    public void showArchitecture() {
        ...
        btn_showCreate.addSelectionListener(new PluginBtnListener(visual, lbl_img, head_description));
        ...
        btn_showRevoke.addSelectionListener(new PluginBtnListener(visual, lbl_img, head_description));
        ...
        btn_showCheck.addSelectionListener(new PluginBtnListener(visual, lbl_img, head_description));
        ...
        btn_continue.addSelectionListener(new PluginBtnListener(visual, lbl_img, head_description));
