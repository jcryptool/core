...
public class PluginBtnListener implements SelectionListener {
	...
	public void widgetSelected(SelectionEvent arg0) {
		...
		if (text.equals("Mit Plugin fortfahren")) {
		...
		} else if (text.equals("Zertifikatserzeugung zeigen")) {
			help = Activator.getImageDescriptor("icons/minica_create.png")
					.createImage();
			...
			util.set_image_name("Architekturskizze Zertifikatserzeugung");
		} else if (text.equals("Zertifikatswiderruf zeigen")) {
			help = Activator.getImageDescriptor("icons/minica_revoke.png")
					.createImage();
			...
			util.resize_image(lbl_img, comp_image, help);
			util.set_image_name("Architekturskizze Zertifikatswiderruf");
		} else if (text.equals("Signaturprüfung zeigen")) {
			help = Activator.getImageDescriptor("icons/minica_check.png")
					.createImage();
			...
			util.resize_image(lbl_img, comp_image, help);
			util.set_image_name("Architekturskizze Signaturprüfung");
