...
public class UserShowCertsListener implements SelectionListener {
     ...
     * @param btn_revoke
     */
    public UserShowCertsListener(Label lbl_value_common, Label lbl_value_org, Label lbl_value_orgUnit,
            Label lbl_value_city, Label lbl_value_country, Label lbl_value_mail, Label lbl_value_common_by,
            Label lbl_value_org_by, Label lbl_value_orgUnit_by, Label lbl_value_issued_on, Label lbl_value_expired_on,
            Button btn_revoke) {
