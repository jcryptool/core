...
public class ShowRevReq implements Views {
	...
	public ShowRevReq(Composite content, Composite exp) {
		...
		showCSRGroup.setText(Messages.ShowRevReq_verify_csr);
		...
		lst_csr.add(Messages.ShowRevReq_dummy_csr0);
		lst_csr.add(Messages.ShowRevReq_dummy_csr1);
		lst_csr.add(Messages.ShowRevReq_dummy_csr2);
		lst_csr.add(Messages.ShowRevReq_dummy_csr3);

		lbl_firstname = new Label(center, SWT.NONE);
		lbl_firstname.setText(Messages.ShowRevReq_first_name);
		lbl_value_firstname = new Label(center, SWT.NONE);
		lbl_value_firstname.setText(Messages.ShowRevReq_dummy_first_name);

		lbl_lastname = new Label(center, SWT.None);
		lbl_lastname.setText(Messages.ShowRevReq_last_name);
		lbl_value_lastname = new Label(center, SWT.None);
		lbl_value_lastname.setText(Messages.ShowRevReq_dummy_last_name);

		lbl_street = new Label(center, SWT.None);
		lbl_street.setText(Messages.ShowRevReq_street);
		lbl_value_street = new Label(center, SWT.None);
		lbl_value_street.setText(Messages.ShowRevReq_dummy_street);

		lbl_ZIP = new Label(center, SWT.None);
		lbl_ZIP.setText(Messages.ShowRevReq_zip_code);
		lbl_value_ZIP = new Label(center, SWT.None);
		lbl_value_ZIP.setText(Messages.ShowRevReq_dummy_zip_code);

		lbl_city = new Label(center, SWT.None);
		lbl_city.setText(Messages.ShowRevReq_city);
		lbl_value_city = new Label(center, SWT.None);
		lbl_value_city.setText(Messages.ShowRevReq_dummy_city);

		lbl_country = new Label(center, SWT.None);
		lbl_country.setText(Messages.ShowRevReq_country);
		lbl_value_country = new Label(center, SWT.None);
		lbl_value_country.setText(Messages.ShowRevReq_dummy_time);

		lbl_mail = new Label(center, SWT.None);
		lbl_mail.setText(Messages.ShowRevReq_email);
		lbl_value_mail = new Label(center, SWT.None);
		lbl_value_mail.setText(Messages.ShowRevReq_dummy_email);

		btn_verify_identity = new Button(center, SWT.NONE);
		btn_verify_identity.setText(Messages.ShowRevReq_verify_identity);
		btn_verify_identity.setLayoutData(new GridData(SWT.FILL, SWT.FILL,
				true, true));
		btn_reject_csr = new Button(center, SWT.NONE);
		btn_reject_csr.setText(Messages.ShowRevReq_csr_deny);
