...
public class ViterbiView extends ViewPart {
    ...
    public final void createPartControl(final Composite parent) {
        ...
        PlatformUI.getWorkbench().getHelpSystem().setHelp(parent, ViterbiPlugin.PLUGIN_ID + ".view"); //$NON-NLS-1$
    }
    ...
    /**
     * This class changes the active Tab from the XOR Tab to the Viterbi Tab. It does not work the other way. Informs
     * the Viterbi-Tab about the ciphertext and the combination used to create the cipher text
     *
     * @param ciphertext the ciphertext that has been entered, and should be displayed in the other tab
     * @param combi the type of combination that has been chosen by the user
     *
     */
