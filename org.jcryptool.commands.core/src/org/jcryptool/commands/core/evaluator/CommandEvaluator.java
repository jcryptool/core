...
public class CommandEvaluator {
	...
	public enum ResultType {
		...
		/**
		 * @return true, if, and only if, the computation of the command string finished without impairing the quality of the result. Intended to return true even when minor warnings occur (like, an algorithm key is "a", which causes a warning that this won't really encrypt a message, but since this is a valid input, this method returns true).
		 */
	...
	/**
	 * Sprits command Arg String into its parts. Needs to parse text cause of
	 * " " text grouping. \" escapes " for text usage.
	 *
	 * @param commandArgs
	 * @return
