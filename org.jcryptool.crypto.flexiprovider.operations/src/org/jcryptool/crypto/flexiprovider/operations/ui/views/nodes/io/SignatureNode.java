...
public class SignatureNode extends TreeNode {

	private String signature;

	public SignatureNode() {
		super(Messages.SignatureNode_0);
	}

	public void setSignature(String signature) {
		this.signature = signature;
		setName(NLS.bind(Messages.SignatureNode_1, this.signature));
	...
	public ImageDescriptor getImageDescriptor() {
		return ImageService.getImageDescriptor(FlexiProviderOperationsPlugin.PLUGIN_ID, "icons/16x16/kgpg_sign.png");
	}
