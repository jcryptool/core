...
public class SelectSignatureAction extends Action {
     ...
     * @throws Exception if the operation is as yet undefined (UNKNOWN)
     */
    private int determineFileDialogType() throws Exception {
    	...
    	case UNKNOWN:
    	default:
    		throw new Exception("must select operation type SIGN or VERIFY first");
    	}
    }
}
