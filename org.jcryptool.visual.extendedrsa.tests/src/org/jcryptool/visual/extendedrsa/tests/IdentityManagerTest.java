...
public class IdentityManagerTest {
	...
	public void testSaveRSAKeyToKeystore() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveRSAKeyToKeystore(TESTID, PASSWORD, new BigInteger("35"), new BigInteger("5"), new BigInteger("7"), new BigInteger("11"), new BigInteger("11"));
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testSaveRSAKeyToKeystore_1() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveRSAKeyToKeystore(null, PASSWORD, new BigInteger("35"), new BigInteger("5"), new BigInteger("7"), new BigInteger("11"), new BigInteger("11"));
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testSaveRSAKeyToKeystore_2() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveRSAKeyToKeystore(TESTID, null, new BigInteger("35"), new BigInteger("5"), new BigInteger("7"), new BigInteger("11"), new BigInteger("11"));
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testSaveRSAKeyToKeystore_3() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveRSAKeyToKeystore(TESTID, PASSWORD, BigInteger.ZERO, new BigInteger("5"), new BigInteger("7"), new BigInteger("11"), new BigInteger("11"));
	}
	@Test(expected = IllegalArgumentException.class)
	public void testSaveRSAKeyToKeystore_4() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveRSAKeyToKeystore(TESTID, PASSWORD, new BigInteger("35"), BigInteger.ZERO, new BigInteger("7"), new BigInteger("11"), new BigInteger("11"));
	}
	@Test(expected = IllegalArgumentException.class)
	public void testSaveRSAKeyToKeystore_5() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveRSAKeyToKeystore(TESTID, PASSWORD, new BigInteger("35"), new BigInteger("5"), BigInteger.ZERO, new BigInteger("11"), new BigInteger("11"));
	}
	@Test(expected = IllegalArgumentException.class)
	public void testSaveRSAKeyToKeystore_6() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveRSAKeyToKeystore(TESTID, PASSWORD, new BigInteger("35"), new BigInteger("5"), new BigInteger("7"), BigInteger.ZERO, new BigInteger("11"));
	}
	@Test(expected = IllegalArgumentException.class)
	public void testSaveRSAKeyToKeystore_7() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveRSAKeyToKeystore(TESTID, PASSWORD, new BigInteger("35"), new BigInteger("5"), new BigInteger("7"), new BigInteger("11"), BigInteger.ZERO);
	}

	@Test
	public void testSaveMpRSAKeyToKeystore() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveMpRSAKeyToKeystore(TESTID, PASSWORD, 3, new BigInteger("385"), new BigInteger("5"), new BigInteger("7"), new BigInteger("11"), BigInteger.ZERO, BigInteger.ZERO, new BigInteger("11"),new BigInteger("131"));
	}
	
	public void testSaveMpRSAKeyToKeystore_4primes() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveMpRSAKeyToKeystore(TESTID, PASSWORD, 4, new BigInteger("5005"), new BigInteger("5"), new BigInteger("7"), new BigInteger("11"), new BigInteger("13"), BigInteger.ZERO, new BigInteger("11"),new BigInteger("1091"));
	}
	
	public void testSaveMpRSAKeyToKeystore_5primes() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveMpRSAKeyToKeystore(TESTID, PASSWORD, 5, new BigInteger("85085"), new BigInteger("5"), new BigInteger("7"), new BigInteger("11"), new BigInteger("13"), new BigInteger("11"), new BigInteger("17"),new BigInteger("3491"));
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void testSaveMpRSAKeyToKeystore_invalid1() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveMpRSAKeyToKeystore(TESTID, PASSWORD, 4, new BigInteger("385"), new BigInteger("5"), new BigInteger("7"), new BigInteger("11"), BigInteger.ZERO, BigInteger.ZERO, new BigInteger("11"),new BigInteger("131"));
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void testSaveMpRSAKeyToKeystore_invalid2() {
		IdentityManager im = IdentityManager.getInstance();
		im.saveMpRSAKeyToKeystore(TESTID, PASSWORD, 5, new BigInteger("385"), new BigInteger("5"), new BigInteger("7"), new BigInteger("11"), BigInteger.ZERO, BigInteger.ZERO, new BigInteger("11"),new BigInteger("131"));
	}
