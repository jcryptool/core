...
public class SigComposite extends Composite {
    ...
    public SigComposite(Composite parent, int style, SigView view) {
        ...
        TitleAndDescriptionComposite titleAndDescription = new TitleAndDescriptionComposite(introComposite);
        titleAndDescription.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1));
        titleAndDescription.setTitle(Messages.SigComposite_lblHeader);
        titleAndDescription.setDescription(Messages.SigComposite_description);
