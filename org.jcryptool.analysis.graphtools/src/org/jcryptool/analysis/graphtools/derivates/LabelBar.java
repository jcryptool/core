...
/**
 * @author SLeischnig A bar derivate that displays custom labels on the top and
 *         bottom.
 */
public class LabelBar extends Bar {
	 ...
	 * @param pUpperLabel  the label which is displayed above the Bar (e. g.
	 *                     detailed bar's height)
	 * @param pLlowerLabel the label which is displayed below the Bar (e. g.
	 *                     x-axis-label)
	 */
	 ...
	 *                      x-axis-label)
	 */
	public LabelBar(double height, double width, int index, int order, MColor colorMainBar, String pUpperLabel,
			String pLowerLabel) {
	 ...
	 *                      x-axis-label)
	 */
	public LabelBar(double height, double width, int index, int order, Rectangle box, MColor colorMainBar, GC gc,
	...
	@Override
	/**
	 * * Draws the lower label of the bar to your graph. Preferred to draw this in
	 * the Lower description area - drawing procedure.<br />
	 * Font color and other things have to be specified manually.
	 * 
	...
	/**
	 * Draws the lower label of the bar to your graph. Preferred to draw this in the
	 * Lower description area - drawing procedure.<br />
	 * Font color and other things have to be specified manually.
	 * 
	 * @param textSpace the Rectangle that your text can fill.
	 * @param myGC      the graphical context
