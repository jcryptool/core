...
/**
 * @author SLeischnig
 * A bar derivate that uses an overlay-ish transparency drawing.
 */
public class OverlayBar extends Bar {
     ...
     * @param gc
     */
    public OverlayBar(double height, double width, int index, int order, Rectangle box,
            MColor colorMainBar, GC gc) {
