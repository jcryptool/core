...
/**
 * @author SLeischnig A bar derivate that uses an overlay-ish transparency
 *         drawing.
 */
public class OverlayBar extends Bar {
	 ...
	 *                in the foreground.
	 */
	public OverlayBar(double height, int index, int order) {
	 ...
	 */
	public OverlayBar(double height, double width, int index, int order, MColor colorMainBar) {
	 ...
	 * @param gc
	 */
	public OverlayBar(double height, double width, int index, int order, Rectangle box, MColor colorMainBar, GC gc) {
