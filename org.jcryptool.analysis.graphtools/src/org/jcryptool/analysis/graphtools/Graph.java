...
/**
 * The standard Graph class. Displays a range of Bars, which have to be added to
 * the Graph. Designed for extension for customized use
 *
 * @author SLeischnig
 */
...
public class Graph {
	...
	// ## without overkilling a procedures parameter list or overwriting the
	// function
	...
	protected void calcAreas() {
		...
		barAreaRect = new Rectangle(distLeft, distTop, areaWidth - distLeft - distRight,
				areaHeight - distTop - distBottom);
	}
	 ...
	 *
	 * @return false, if bar1 is drawn earlier than bar2, true, if bar1 is drawn
	 *         later than bar2.
	 */
	 ...
	 *
	 * @param rawBar The bar that has to be added to the graph, but has possibly
	 *               properties that have to be filled by standard settings.
	...
	/**
	 * add a new bar into the bar array. It will be automatically sorted in for
	 * drawing order.
	 *
	...
	/**
	 * Paint procedure for the whole painting Area. Calls the painting procedures
	 * for the other paint areas. \nOverride this only if you have structural
	 * changes to make e. g. concerning the number of painting areas or adding
	 ...
	 * Used to call the function without the parameters (they already exist as
	 * fields)
	 */
	...
	/**
	 * Helps you to calculate the GC.drawText() position for a text you want to
	 * center on a given point
	 *
	 * @param myText  is the String you want to draw
	 * @param midX    where do you want the text to center?
	 * @param topMidY where do you want the text to center? (defines the text's top
	 *                border)
	 * @param metrics the fontMetrics, e. g. by your GC parameter
	 * @return a point which coordinates you can use directly in your drawText()
	 *         call
	 */
