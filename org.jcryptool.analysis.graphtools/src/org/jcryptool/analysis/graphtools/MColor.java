...
public class MColor {
	...
	// Specify the color as RGB values plus the alpha value, plus instantly setting
	// it.
	...
	// Specify the color as 6-digit hexadecimal value in a String plus the alpha
	// value.
	...
	// Specify the color as an integer value plus the alpha valu, plus instant
	// setting it.
