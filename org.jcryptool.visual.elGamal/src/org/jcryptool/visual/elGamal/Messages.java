...
public class Messages extends NLS {
	...
	public static String ChooseKPage_enter_k;
	public static String ChooseKPage_select_k_text;
	...
	public static String ElGamalComposite_textentry_text;
	public static String ElGamalComposite_title;
	public static String ElGamalComposite_valid;
	public static String ElGamalComposite_verify;
    public static String ElGamalData_inherit_password_text;
    public static String ElGamalData_inherit_password_title;
    public static String ElGamalData_ExAccessKeystorePassword;
	public static String EncryptVerifyPage_choose_action;
	public static String EncryptVerifyPage_choose_action_text;
	public static String EncryptVerifyPage_load_key;
	public static String EncryptVerifyPage_load_key_popup;
	public static String EncryptVerifyPage_manual_entry;
	public static String EncryptVerifyPage_manual_entry_popup;
	public static String EnterCiphertextPage_ciphertext_text;
	...
	public static String EnterPlaintextPage_textentry;
	...
	public static String EnterSignaturePage_enter_signature_text;
	public static String EnterSignaturePage_error_invalid_r;
	public static String EnterSignaturePage_error_invalid_s;
	public static String EnterSignaturePage_signatureen;
	public static String EnterSignaturePage_textentry;
	...
	public static String LoadKeypairPage_select_keypair_text;
	...
	public static String NewKeypairPage_choose_q_text;
	public static String NewKeypairPage_error_invalid_a;
	...
	public static String NewKeypairPage_select_a;
	...
	public static String NewPublicKeyPage_select_g;
	...
	public static String SaveKeypairPage_save_keypair;
	public static String SavePublicKeyPage_enter_name;
	public static String SavePublicKeyPage_enter_save_params;
