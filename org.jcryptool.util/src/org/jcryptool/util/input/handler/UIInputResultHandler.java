...
*******************************************************************************/
//-----END DISCLAIMER-----
package org.jcryptool.util.input.handler;
...
/**
 * Interface for handling the InputVerificationResults that come from UIInputs.
 * For example, register the implementing class as Observer to the AbstractUIInput
 * and direct all InputVerificationResults to {@link #handleVerificationResultMsg(InputVerificationResult)}.
 * 
 * @author Simon L
 */
