...
public abstract class TextfieldInput<Content> extends AbstractUIInput<Content> {
	...
	/**
	 * Creates a AbstractUIInput which listens (for now) to a given textfield,
	 * reacts when the textfield changes, and resets the cursor properly when
	...
	/**
	 * Method that should be used to set the text of the text field
	 * instead of the textfield.setText method. This is ugly, but
	 * necessary, because the modifyText-Event responds to Text.setText(..),
	 * too.
	 *
