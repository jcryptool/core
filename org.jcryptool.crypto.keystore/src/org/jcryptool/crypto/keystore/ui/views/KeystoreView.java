...
public class KeystoreView extends ViewPart implements ISelectedNodeListener, IViewKeyInformation {
    ...
    private final String exportCertificateCommandId = "org.jcryptool.keystore.commands.exportCertificate";
    ...
    private final String newContactCommandId = "org.jcryptool.keystore.commands.newContact";
    private final String deleteContactCommandId = "org.jcryptool.keystore.commands.deleteContact";
    ...
    private final String deleteSecretKeyCommandId = "org.jcryptool.keystore.commands.deleteSecretKey";
    private final String deleteKeyPairCommandId = "org.jcryptool.keystore.commands.deleteKeyPair";
    private final String deleteCertificateCommandId = "org.jcryptool.keystore.comands.deleteCertificate";
    ...
    private void defineAllCommands() {
        ...
        defineCommand(deleteContactCommandId, Messages.getString("Label.DeleteContact"), deleteContactHandler);

        defineCommand(deleteCertificateCommandId, Messages.getString("Label.DeleteCertificate"), deleteCertificateHandler);
        defineCommand(deleteKeyPairCommandId, Messages.getString("Label.DeleteKeyPair"), deleteKeyPairHandler);
        defineCommand(deleteSecretKeyCommandId, Messages.getString("Label.DeleteSecretKey"), deleteSecretKeyHandler);
    ...
    private void fillLocalPullDown(IMenuManager manager) {
        ...
        manager.add(new Separator());
        defineCommand(commandIdBackup, Messages.getString("Menu.BackupRestoreKeystore"), new KeyStoreBackupHandler());
