 ...
 * 
 */
public class MeRSAPrivateKeyContentProvider extends AbstractKeyNodeContentProvider {
    ...
    protected List<TableEntry> getAlgorithmElements(Object inputElement) {
        ...
        try {
            ...
            paramElements.add(new TableEntry(Messages.ContentProvider_einvp, "" + key.getEInvP())); //$NON-NLS-2$
