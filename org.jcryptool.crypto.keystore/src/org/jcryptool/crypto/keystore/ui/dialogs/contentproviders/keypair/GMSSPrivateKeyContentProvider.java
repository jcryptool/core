...
public class GMSSPrivateKeyContentProvider extends AbstractKeyNodeContentProvider {
    ...
    protected List<TableEntry> getKeySpecElements(Key key) {
        ...
        try {
            ...
            if (keySpec == null)
                return null;
            paramElements.add(new TableEntry(Messages.ContentProvider_algnames, "" + Arrays.toString(keySpec.getAlgNames()))); //$NON-NLS-2$
            ...
            paramElements.add(new TableEntry(Messages.ContentProvider_mintreehash, "" + Arrays.toString(keySpec.getMinTreehash()))); //$NON-NLS-2$
            paramElements.add(new TableEntry(Messages.ContentProvider_nextauthpath, "" + keySpec.getNextAuthPath())); //$NON-NLS-2$
            paramElements.add(new TableEntry(Messages.ContentProvider_nextnextleaf, "" + Arrays.toString(keySpec.getNextNextLeaf()))); //$NON-NLS-2$
            paramElements.add(new TableEntry(Messages.ContentProvider_nextnextroot, "" + Arrays.toString(keySpec.getNextNextRoot()))); //$NON-NLS-2$
            ...
            paramElements.add(new TableEntry(Messages.ContentProvider_nextrootsig, "" + Arrays.toString(keySpec.getNextRootSig()))); //$NON-NLS-2$
            ...
            paramElements.add(new TableEntry(Messages.ContentProvider_upperleaf, "" + Arrays.toString(keySpec.getUpperLeaf()))); //$NON-NLS-2$
            paramElements.add(new TableEntry(Messages.ContentProvider_uppertreehashleaf, "" + Arrays.toString(keySpec.getUpperTreehashLeaf()))); //$NON-NLS-2$
