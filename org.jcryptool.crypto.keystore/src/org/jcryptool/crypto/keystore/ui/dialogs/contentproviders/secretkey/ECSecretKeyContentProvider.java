 ...
 * 
 */
public class ECSecretKeyContentProvider extends AbstractKeyNodeContentProvider {
    ...
    protected List<TableEntry> getAlgorithmElements(Object inputElement) {
        ...
        try {
            ...
            paramElements.add(new TableEntry(Messages.ContentProvider_s, "" + key.getS())); //$NON-NLS-2$
