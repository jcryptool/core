 ...
 * 
 */
public class McEliecePublicKeyContentProvider extends CertificateContentProvider {
    ...
    protected List<TableEntry> getAlgorithmElements(Object inputElement) {
        ...
        try {
            McEliecePublicKey key = (McEliecePublicKey) inputElement;
            if (key == null)
                return null;
    ...
    protected List<TableEntry> getKeySpecElements(Key key) {
        ...
        try {
            ...
            McEliecePublicKeySpec keySpec = (McEliecePublicKeySpec) keyFactory.getKeySpec(key,
                    McEliecePublicKeySpec.class);
            if (keySpec == null)
                return null;
            ...
            paramElements.add(new TableEntry(Messages.ContentProvider_g, "" + keySpec.getG())); //$NON-NLS-2$
