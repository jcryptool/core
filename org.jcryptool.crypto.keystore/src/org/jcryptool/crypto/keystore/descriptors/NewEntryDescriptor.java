...
public class NewEntryDescriptor implements INewEntryDescriptor {
	...
	public NewEntryDescriptor(String contactName, String algoName, String displayedName, int keyLength, String password, String provider, KeyType type) {
