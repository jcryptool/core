...
public class NewSecretKeyDescriptor extends NewEntryDescriptor implements
INewSecretKeyDescriptor {

	private SecretKey secretKey;

	public NewSecretKeyDescriptor(INewEntryDescriptor descriptor, SecretKey secretKey) {
		super(descriptor.getContactName(),
				descriptor.getAlgorithmName(),
				descriptor.getDisplayedName(),
				descriptor.getKeyLength(),
				descriptor.getPassword(),
				descriptor.getProvider(),
				descriptor.getKeyStoreEntryType()
		);
