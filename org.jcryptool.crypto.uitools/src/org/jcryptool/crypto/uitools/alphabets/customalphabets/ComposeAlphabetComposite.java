...
import org.jcryptool.crypto.uitools.UIToolsPlugin;
import org.jcryptool.crypto.uitools.alphabets.alphabetblocks.BlockAlphabet;
import org.jcryptool.crypto.uitools.alphabets.alphabetblocks.ExcludeCharBlock;
import org.jcryptool.crypto.uitools.alphabets.alphabetblocks.HasOriginalBlockAlpha;
import org.jcryptool.crypto.uitools.alphabets.alphabetblocks.NewAlphabetBlockWizard;
import org.jcryptool.crypto.uitools.alphabets.alphabetblocks.RangeBlockAlphabet;
import org.jcryptool.crypto.uitools.alphabets.alphabetblocks.RevertBlock;
import org.jcryptool.crypto.uitools.alphabets.alphabetblocks.paramselectionui.LeaveOutCharSelectorWizard;
import org.jcryptool.crypto.uitools.alphabets.composite.AtomAlphabet;
import org.jcryptool.crypto.uitools.alphabets.composite.CompositeAlphabet;
...
//			label.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
			...
			Image showExistingImg = UIToolsPlugin.getImageDescriptor("img/search.gif").createImage(); //$NON-NLS-1$
...
//			Image showImg = PlatformUI.getWorkbench().getSharedImages().getImage(ISharedImages.IMG_OBJ_ADD);
			Image showImg = UIToolsPlugin.getImageDescriptor("img/search.gif").createImage(); //$NON-NLS-1$
