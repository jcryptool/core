 ...
 *******************************************************************************/
// -----END DISCLAIMER-----
package org.jcryptool.crypto.uitools.textmodify.wizard;
...
public class ModifySelectionComposite extends Composite implements Listener {
    ...
    public ModifySelectionComposite(Composite parent, int style, TransformData defaultData) {
        ...
        try {
            ...
            LogUtil.logError(UIToolsPlugin.PLUGIN_ID, e);
        }
    ...
    public final void handleEvent(final Event event) {
        if (event.widget == uppercase) {
            ...
            if (text == null)
                JCTMessageDialog.showInfoDialog(new Status(IStatus.INFO, UIToolsPlugin.PLUGIN_ID,
    ...
    private String InputStreamToString(InputStream in) {
        ...
        try {
            ...
            LogUtil.logError(UIToolsPlugin.PLUGIN_ID, e1);
        }
