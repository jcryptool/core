...
public class AnalysisWizard extends Wizard implements TranspositionAnalysisInput {
	 ...
	 * @param dataobject, if there is analysis data that should be displayed as first page, before starting a new analysis. null for not showing a  cinclusion first, but starting a new analysis straightaway.
	 */
	...
	public SingleAnalysisPage nextPageFrom(SingleAnalysisPage actual) {
		...
		while(selectionPage.getNextAnalysisAfter(actualAnalysis) != null) { // while there is a next analysis
			...
			if(nextAnalysisPage != null) { // if there is a page for this analysis
				// return this page
