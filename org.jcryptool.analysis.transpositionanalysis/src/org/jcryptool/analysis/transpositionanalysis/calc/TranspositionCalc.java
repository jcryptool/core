...
public class TranspositionCalc {
	...
	/**
	 * Returns possible blocklengths for the text by finding divisors. A lower and higher margin
	 * for the results can be given.
	 *
	 * @param marginLow the lower margin for returned results (results can be >= lower margin)
	 * @param marginHigh the higher margin for results (results can be <= margin), or -1 for no limitation
	 * @return
	 */
