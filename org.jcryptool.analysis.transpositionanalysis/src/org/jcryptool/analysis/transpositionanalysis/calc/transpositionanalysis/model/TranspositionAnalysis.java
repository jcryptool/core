...
/**
 * Transposition Analysis, which performs analysis steps. The output of this analysis
 * is combined with the already existing content of a given output object, which should be set previous to calling the analyze-function, or it will be newly created.
 *  
 * 
 * @author Simon L
 *
...
public abstract class TranspositionAnalysis extends Analysis {
	...
	/**
	 * Set the Transposition analysis output (e. g. for combining multiple analysis methods)
	 * 
	...
	/**
	 * @return a conclusion object, which contains a concise descriptive conclusion of the single analysis step, normally inclusive the best candidates for the solution.
	 */
	...
	/**
	 * Returns, whether this analysis is prepared to process a user estimated analysis rating
	 * 
	 * @return
	 */
