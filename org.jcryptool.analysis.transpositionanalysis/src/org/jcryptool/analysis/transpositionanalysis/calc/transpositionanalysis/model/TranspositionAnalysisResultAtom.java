...
/**
 * An atom of a transposition analysis result, meaning one possible
 * configuration ready to be displayed. As some analysis only calculate the
 * column count, the atom has a flag for using only the length of the stored
 * transposition key.
 * 
 * @author Simon L
 * 
...
public class TranspositionAnalysisResultAtom {
	...
	public TranspositionAnalysisResultAtom(TranspositionKey result, boolean onlyAboutLength) {
		super();
		this.result = result;
