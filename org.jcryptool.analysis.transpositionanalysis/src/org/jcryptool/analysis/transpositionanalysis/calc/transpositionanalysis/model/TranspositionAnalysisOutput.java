...
/**
 * This class is used for making the result of the TranspositionAnalysis global for all 
 * partial analysis methods. It contains <br />
 * - a Map, which maps a keylengths to 
 * PolledTranspositionKeys of this length (To decide about the key itself). <br />
 * - a PolledPositiveInteger, which
 * is used to decide about the key length.
 * 
 * @author Simon L
 *
 */
public interface TranspositionAnalysisOutput extends AnalysisOutput {
	 ...
	 * 
	 * @param keys A map, that maps possible keylengths to PolledTranspositionKeys (of that length each!)
	 */
