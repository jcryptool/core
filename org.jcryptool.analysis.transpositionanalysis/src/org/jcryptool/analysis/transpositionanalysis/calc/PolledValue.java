...
public class PolledValue<T> {
	...
	/** Add a choice to poll from, with default possibility. <br /> If the choice already exists, it will be overwritten.
	 * 
	...
	/**
	 * Add a choice to poll from. <br /> If the choice already exists, it will be overwritten.
	 * 
	 * @param choice the integer
	...
	/**
	 * combines the possibilities of two polledIntegers into one. This Instance of PolledInteger will be altered, but will also return itself.
	 * 
	...
	public PolledValue<T> combineWith(PolledValue<T> combineSubject) {
		...
		for(T removeElement: removeSet) this.removeChoice(removeElement);
		
		return this;
	}
	
	/**
	 * combines a current possibility with another one, by multiplying the possibilities.
	 * 
	...
	/**
	 * Returns a clone of this polledValue, where all possibilities are set to {@link #POSSIBILITY_DEFAULT}.
	 */
