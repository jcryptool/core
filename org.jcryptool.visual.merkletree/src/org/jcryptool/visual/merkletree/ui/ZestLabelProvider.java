...
/**
 * @author Christoph Sonnberger This class defines the labeling, color and tooltips of the nodes
...
public class ZestLabelProvider extends LabelProvider implements IEntityStyleProvider {
    ...
    /**
     * @author Christoph Sonnberger Constructor for the Class ZestLabelProvider
    ...
    /**
     * @author Christoph Sonnberger Method used to label the Nodes and Connectionlines of the Merkle
    ...
    /**
     * @author Christoph Sonnberger sets the background color (defined in constructor) of the nodes
    ...
    /**
     * @author Christoph Sonnberger sets the Tooltip when mouse hovers of a node Every node is
     *         showing its hash
     */
    @Override
