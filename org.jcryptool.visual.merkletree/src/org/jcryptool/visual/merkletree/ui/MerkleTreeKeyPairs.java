...
public class MerkleTreeKeyPairs extends Composite {
    ...
    /**
     * Create the composite. Including KeyPair content and button for keyPair generation
     * 
     * @param parent
     * @param style
     */
    public MerkleTreeKeyPairs(Composite parent, int style, SUIT mode, ViewPart masterView) {
        ...
        /**
         * Event Listener for the generate keys button if this button is pressed a new merkle tree
         * is generated
         */
        buttonCreateKeys.addSelectionListener(new SelectionAdapter() {
             ...
             * SelectionEvent) generates the MerkleTree and the KeyPairs
             */
            @Override
            public void widgetSelected(SelectionEvent e) {
