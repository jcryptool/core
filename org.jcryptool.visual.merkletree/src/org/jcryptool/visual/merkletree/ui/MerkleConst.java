...
public abstract class MerkleConst {
	...
	// Identifies a plain text data vector, as well as a wizard for changing the
	// plain text
	...
	// height of labels and buttons of the datavector (except those labels which
	// display actual
	// data)
	public static final int DATAVECTOR_VISUAL_L_B_HEIGHT = 30;

	// width of labels and buttons of the datavector (except those labels which
	// display actual data)
	...
	// Default value of Spritz parameter w; offset one in the list is equal to
	// the value three
	public static final int DEFAULT_W_INDEX = 1;

	// Default value of Spritz parameter w; ATTENTION there is a dependency
	// between
	// this variable and DEFAULT_W_INDEX: THEY HAVE TO BE THE SAME!
	// These really shouldn't be two separate variables, but checkstyle wown't
	// shut up otherwise
