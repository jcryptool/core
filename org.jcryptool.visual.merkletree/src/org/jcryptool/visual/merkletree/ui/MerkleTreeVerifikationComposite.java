...
public class MerkleTreeVerifikationComposite extends Composite implements IZoomableWorkbenchPart {
    ...
    /**
     * Create the composite. Including Description, GraphItem, GraphView, Description for GraphView
     * 
     * @param parent
     * @param style
     */
    public MerkleTreeVerifikationComposite(Composite parent, int style, ISimpleMerkle merkle, int leafNumber,
        ...
        /*
         * The Text is based on the used suite if there will implemented an other suite, just add an
         * else if and type the name of the instance Example for MultiTree -> merkle instanceof
         * XMSSMT
         */
        ...
        /*
         * Text field for the binary representation of the node this The textbox is filled in the
         * method markAuthPath()
         */
        ...
        graph.addSelectionListener(new SelectionAdapter() {
             ...
             * SelectionEvent) Click-Event to get the Selected Node and to mark the other Nodes
             */
            @Override
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (currentLeaf >= 0) {
                    if (merkle.verify(message, signature, currentLeaf)) {
                        /*
                         * set the Screen color based on the result green if verification success
                    ...
                    /*
                     * if selected item is a node then show message that node cant be used to verify
                     * signature
                     */
                    styledTextTree.setBackground(ColorConstants.red);
