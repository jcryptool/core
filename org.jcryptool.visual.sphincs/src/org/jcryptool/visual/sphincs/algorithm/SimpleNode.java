 ...
 * only add one Contructor, for sphincs public key
 * 
 * 
 */
public class SimpleNode implements Node{
     ...
     * Creates a node
     * 
     * For Public Key Wots Structur
     * 
     *                  PK -> WOTS : Left and Right Node
     * 
     * @param name name of the node
     * @param value the probability of the node
     * @param left left child
     * @param right right child
     *  @param root public key
     */
    public SimpleNode(String content, /* double value, */ Node left, Node right, Node root) {
     ...
     * 
     * @param name name of the node.
     * @param leaf true if leaf false if not
     */
    public SimpleNode(String content, boolean leaf, int index) {
        this.content = content;
        this.leaf = leaf;
        connections = new ArrayList<Node>();
        this.index = index;
     ...
     * @param right right child
     */
    public SimpleNode(String content, /* double value, */ Node left, Node right) {
        this.content = content;
        // this.value = value;
        this.left = left;
        this.right = right;
     ...
     * @param right right child
     */
    public SimpleNode(String content, int index) {
        this.content = content;
        this.index = index;
        connections = new ArrayList<Node>();
    }
     ...
     * 
     * @param value value of the node (probability)
     */
     ...
     * 
     * @param parent the parent node. Null if node is the root node
     */
    ...
    /**
     * Returns the code of the Node only when the node is a leaf (Represents the Public Key)
     * 
     ...
     * 
     * @param code the code of the leaf
     */
