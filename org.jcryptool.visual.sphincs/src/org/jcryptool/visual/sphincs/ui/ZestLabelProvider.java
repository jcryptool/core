...
/**
 * @author Philipp Guggenberger This class defines the labeling, color and
 *         tooltips of the nodes Used when building the SphincsTree
 */
...
public class ZestLabelProvider extends LabelProvider implements IEntityStyleProvider {
	...
	/**
	 * @author Philipp Guggenberger Constructor for the Class ZestLabelProvider
	 * @param backgroundColor: sets the backgroundColor of the Nodes used in the
	 *                         Tree
	 * 
	 */
	...
	/**
	 * @author Philipp Guggenberger Method used to label the Nodes and
	 *         Connectionlines of the Sphincs-Tree Scheme Label for Root, Node and
	 *         Leaf Label 0/1 for left/right lines
	 */
	@Override
	...
	/**
	 * @author Philipp Guggenberger sets the background color (defined in
	 *         constructor) of the nodes when tree is created
	...
	/**
	 * @author Philipp Guggenberger sets the Tooltip when mouse hovers of a node
	...
	public IFigure getTooltip(Object entity) {
		if (entity instanceof Node) {
			...
			IFigure tooltip1 = new Label(SphincsDescriptions.ZestLabelProvider_4 + " " + n.getNameAsString() + ")",
					null);
			return tooltip1;
		}
		return null;
