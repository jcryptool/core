...
/**
 * Wraps a normal alphabet into a {@link TextCompatibleAlphabet} by providing
 * the string parsing mechanism (by passing a {@link TextConverter} in the constructor).
 * 
 * @see TextCompatibleAlphabet
 * @see Alphabet
 * @author Simon L
 */
public class TextCompatibleAlphabetWrapper<C> extends
		TextCompatibleAlphabet<C> {

	private TextConverter<C> converter;

	/**
	 * The given alphabet is converted into a {@link TextCompatibleAlphabet}, 
	 * providing its String conversion mechanism by passing a {@link TextConverter}. 
	 * 
	 * @param alphabetToWrap the alphabet to convert
	 * @param converter the TextConverter to parse Strings into alphabet elements
	 */
	public TextCompatibleAlphabetWrapper(Alphabet<C> alphabetToWrap,
			TextConverter<C> converter) {
