...
/**
 * Cryptographic alphabet which provides a function to convert a string 
 * into a list of elements of this alphabet. The other way of the conversion 
 * (alphabet elements to String) is automatically provided by the toString()-
...
public abstract class TextCompatibleAlphabet<C> extends Alphabet<C> {
	...
	/**
	 * Parses a list of elements from this alphabet from a string.
	 * strings should be well-formatted, such, that there will be no
	 * unexpected content. Throws ElementNotInAlphabetException, should
	 * unparseable content be encountered.
	 * 
	 * @param s
	 *            the String
	 * @return a list of Elements from this alphabet
	 * @throws ElementNotInAlphabetException
	 *             when unexpected content occurs (e. g. elements which are not
	 *             parseable within this alphabet)
	 */
	public abstract List<C> parseString(String s)
			throws ElementNotInAlphabetException;
