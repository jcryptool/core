...
public class CharAlphabet extends TextCompatibleAlphabet<Character> {
	...
	/**
	 * Creates an alphabet by specifying its characters. The order in which the
	 * iterator of the collection returns the characters will be maintained.
	 * 
	 * @param alphabetCharacters
	...
	@Override
	public List<Character> parseString(String string)
