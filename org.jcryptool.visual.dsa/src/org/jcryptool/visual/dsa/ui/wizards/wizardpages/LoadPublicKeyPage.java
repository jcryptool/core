...
public class LoadPublicKeyPage extends WizardPage {
    ...
    public LoadPublicKeyPage(final DSAData data) {
        ...
        this.setDescription("Bitte wählen Sie aus, welchen öffentlichen Schlüssel Sie verwenden möchten.");
        this.data = data;
    ...
    public final void createControl(final Composite parent) {
        ...
        new Label(composite, SWT.NONE).setText("Bitte wählen Sie einen öffentlichen Schlüssel aus der Liste aus");
