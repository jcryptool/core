...
public class SavePublicKeyPage extends SaveWizardPage {
	...
	private static final String TITLE = "Öffentlichen Schlüssel speichern.";
	 ...
	 */
	public SavePublicKeyPage(final DSAData data) {
		super(PAGENAME, TITLE, null);
		setPageComplete(false);
		this
				.setDescription("Bitte geben Sie die Speicherparameter für diesen öffentlichen Schlüssel an");
		this.data = data;
	}
