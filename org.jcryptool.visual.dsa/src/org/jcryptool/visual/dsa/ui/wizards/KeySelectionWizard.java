        ...
        try {
            ...
            case VerifyAction:
                if (((EncryptVerifyPage) getPage(EncryptVerifyPage.getPagename())).wantNewKey()) {
                    ...
                    final DSAPublicKey pubkey = (DSAPublicKey) ksm.getCertificate(publicAlias).getPublicKey();
        ...
        try {
            ...
            if (keypair) {
                ...
                final KeyStoreAlias privateAlias = new KeyStoreAlias(data.getContactName(),
                        KeyType.KEYPAIR_PRIVATE_KEY, "", data.getP().bitLength(), data.getContactName()
                                .concat(data.getP().toString()).hashCode()
