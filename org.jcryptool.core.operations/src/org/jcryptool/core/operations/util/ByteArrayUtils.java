...
public final class ByteArrayUtils {
	...
	/**
	 * Concatenates two byte arrays. If one of the arrays is <code>null</code>,
	 * return the other array (i.e., if both are <code>null</code>,
	...
	/**
	 * Splits a byte array <code>input</code> into two arrays at
	 * <code>index</code>, i.e. the first array will have <code>index</code>
	 * bytes, the second one <code>input.length - index</code> bytes.
	 *
	 * @param input -
	 ...
	 *
	 * @return the two halfs of <code>input</code> as an array of two byte
	 *         arrays
	 */
	 ...
	 * @param end -
	 *            the end index
	 * @return a subarray of <code>input</code>, ranging from
	 ...
	 *            the start index
	 * @return a subarray of <code>input</code>, ranging from
	 *         <code>start</code> to the end of the array
	 */
	...
	/**
	 * Convert a byte array of length 4 into an int number, using big-endian
	 * notation
	 *
	 * @param input -
	 *            the byte array
	...
	/**
	 * Convert a byte array of length 4 into an int number, using little-endian
	 * notation
	 *
	 * @param input -
	 *            the byte array
	 * @return the converted int or <tt>0</tt> if <tt>input.length != 4</tt>
	 *         or the resulting integer would be negative
	 */
