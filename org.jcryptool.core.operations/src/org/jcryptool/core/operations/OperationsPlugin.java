 ...
 * Additionally, it providers a point of access to the loaded
 * <code>AlphabetStore</code> of the alphabets Plug-in.
 *
 * @author amro
 * @author t-kern
 * @version 0.6.0
...
public class OperationsPlugin extends AbstractUIPlugin {
    ...
    /**
     * Retrieves the algorithms manager. The extension registry is used to fetch the specific
     * contributor of the <i>org.jcryptool.core.operations</i> plug-in.
     *
     * @return null if there is no specific manager found and an object of AbstractOperationsManager
            ...
            if ("org.jcryptool.core.operations.algorithm.AlgorithmRegistry".equals( //$NON-NLS-1$
                ...
                for (int j = 0; j < configElements.length; j++) {
                    ...
                    if ("manager".equals(element.getName())) { //$NON-NLS-1$
                        try {
                            AbstractOperationsManager manager = (AbstractOperationsManager)
