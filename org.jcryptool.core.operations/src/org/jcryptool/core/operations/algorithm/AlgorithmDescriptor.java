 ...
 * Contains all vital meta-information about the algorithm and methods
 * to access and "lazy-load" the algorithm.
 *
 * @author t-kern
 *
 */
public class AlgorithmDescriptor implements IAlgorithmDescriptor {
	 ...
	 */
	public AlgorithmDescriptor(String name, String type, String algorithmID, String extensionUID, String keylengths, String blocklengths, String tooltipText, boolean isFlexiProviderAlgorithm) {
		this.name = name;
		this.type = type;
