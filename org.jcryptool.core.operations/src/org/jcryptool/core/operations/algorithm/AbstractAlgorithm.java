...
public abstract class AbstractAlgorithm {
	 ...
	 * @return the data object, which specific fields were setted before and
	 * after the execution of the algorithm.
	 */
	public abstract IDataObject execute();

	/**
	 * Subclasses must provide an algorithm name. This name is used for the
	 * <b>Actions view</b> to represent the crypto plug-in.
	 *
