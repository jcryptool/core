...
public abstract class AbstractModernAlgorithm extends AbstractAlgorithm {
	...
	/**
	 * Returns the supporting Provider for the requested algorithm and type.
	 * <br>
	 * If the default Provider supports the requested service, it will be returned. Otherwise,
	 * the fall-through hierarchy will be searched for a Provider that supports the requested
	 * service.<br>
	 ...
	 */
	@SuppressWarnings("deprecation")
	protected Provider getSupportingProvider(String type, String algorithmName) throws CoreException, NoSuchAlgorithmException {
