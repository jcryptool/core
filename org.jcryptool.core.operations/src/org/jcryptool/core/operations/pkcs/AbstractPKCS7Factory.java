...
public abstract class AbstractPKCS7Factory implements IPKCSFactory {
	 ...
	 * @return			<code>true</code>, if the given content is a valid PKCS#7 ContentInfo object; <code>false</code> otherwise. 
	 */
	 ...
	 * For more information on PKCS#7, please refer to
	 * <href>http://www.rsa.com/rsalabs/node.asp?id=2129</href>
	 * 
	 ...
	 */
	public abstract byte[] rsaWithAES(X509Certificate recipient, byte[] encryptedMessage, byte[] encryptedKey, byte[] iv, String cipherMode, int symmetricKeyLength);
