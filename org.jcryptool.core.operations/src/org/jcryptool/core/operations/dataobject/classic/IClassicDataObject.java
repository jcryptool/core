...
public interface IClassicDataObject extends IDataObject {
	...
	/**
	 * Interface implementors must provide a getter for the final output of 
	 * algorithms execution. 
	 * 
	 * Specifically final means final, e. g. for classic algorithms 
	 * if non alpha filters should not be filtered the merged final output.
	 * 
